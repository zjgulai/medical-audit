...
| 审计日志 | 查询、索引发布、回滚、任务复核、报告导出必须留痕；保留期外事件必须进入受控 archive root 后再清理，生产签名模式下必须生成 detached manifest、支持只读验签并提供 archive root 巡检报告 |
