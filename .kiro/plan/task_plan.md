...
- [ ] Run Loop 44: decide whether to push the local UI commit to a remote branch and open/update PR; require explicit authorization and stop before merge, deploy, production probe, provider call, Docker change, or write-path smoke unless separately authorized.
