...
- [ ] Run Loop 38 only if requested: choose between pushing the docs-only commit, rehearsing Group A patch staging, running local fullstack verification, or selecting one new P2 lane with explicit evidence target and authorization boundary.
