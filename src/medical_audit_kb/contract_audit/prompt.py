...
输出必须是可下载报告正文，依次包含：合同概况、审计范围与方法、已收和缺失资料、提取质量、审计发现汇总、发现详情、待核实事项、四维覆盖矩阵、总体结论、整改跟踪、免责声明。汇总表必须分别列出法律依据、商业依据和修改建议；每条发现写明风险等级、条款位置、原文、影响、建议、置信度和是否需人工复核。不得省略证据标记。"""
