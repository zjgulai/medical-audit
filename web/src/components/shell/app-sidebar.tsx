...
export function AppSidebar() {
  ...
  return (
    <aside className="audit-sidebar-shell flex w-full flex-col border-b border-[var(--audit-line)] px-3 py-4 shadow-[0_10px_24px_rgb(23_62_105/0.05)] sm:px-4 md:min-h-screen md:w-[16rem] md:border-r md:border-b-0 md:py-5 md:shadow-[8px_0_24px_rgb(23_62_105/0.05)] xl:w-[17rem]">
      ...
      <div className="mt-4 hidden border-t border-[var(--audit-line)] pt-3 md:block">
