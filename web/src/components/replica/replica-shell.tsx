...
export function ReplicaShell({ children }: ReplicaShellProps) {
  ...
  return (
    ...
    >
      <aside className="replica-sidebar" aria-label="AI 审计应用导航">
        <Link href="/chat" className="replica-brand" aria-label="AI审计应用">
          <span className="replica-brand-mark">AI</span>
          <span className="replica-brand-text">AI审计应用</span>
        </Link>
